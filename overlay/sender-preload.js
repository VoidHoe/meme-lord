...
contextBridge.exposeInMainWorld('sender', {
  ...
  listChaseSessions: ()              => ipcRenderer.invoke('list-chase-sessions'),
  createChaseSession: ()             => ipcRenderer.invoke('create-chase-session'),
  joinChaseSession: (code)           => ipcRenderer.invoke('join-chase-session', code),
  leaveChaseSession: ()              => ipcRenderer.invoke('leave-chase-session'),
  getChaseSession: (code)            => ipcRenderer.invoke('get-chase-session', code),
  submitChaseSessionScore: (ms)      => ipcRenderer.invoke('submit-chase-session-score', ms),
