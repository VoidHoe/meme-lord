...
contextBridge.exposeInMainWorld('sender', {
  ...
  createChasePlaylist: (name)        => ipcRenderer.invoke('create-chase-playlist', name),
  deleteChasePlaylist: (id)          => ipcRenderer.invoke('delete-chase-playlist', id),
  setChaseMusicPlaylist: (trackId, playlistId, enabled) => ipcRenderer.invoke('set-chase-music-playlist', { trackId, playlistId, enabled }),
  getChaseLeaderboard: ()            => ipcRenderer.invoke('get-chase-leaderboard'),
  getProfile: ()                     => ipcRenderer.invoke('get-profile'),
  getPublicProfile: (username)       => ipcRenderer.invoke('get-public-profile', username),
  chooseProfileAvatar: ()            => ipcRenderer.invoke('choose-profile-avatar'),
  getLolLeaderboard: ()              => ipcRenderer.invoke('get-lol-leaderboard'),
  getLolAccount: ()                  => ipcRenderer.invoke('get-lol-account'),
  linkLolAccount: (payload)          => ipcRenderer.invoke('link-lol-account', payload),
  refreshLolAccount: ()              => ipcRenderer.invoke('refresh-lol-account'),
  submitLolScore: (gain)             => ipcRenderer.invoke('submit-lol-score', gain),
